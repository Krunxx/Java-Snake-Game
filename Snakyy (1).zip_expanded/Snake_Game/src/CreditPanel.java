...
public class CreditPanel extends JPanel  implements ActionListener{
	...
	CreditPanel(){
		...
		gameDesign = new ImageIcon("C:\\Users\\Karen\\eclipse-workspace\\Snakyy (1).zip_expanded\\Snake_Game\\game_design.png").getImage();
		programming = new ImageIcon("C:\\Users\\Karen\\eclipse-workspace\\Snakyy (1).zip_expanded\\Snake_Game\\programming.png").getImage();
		music =  new ImageIcon("C:\\Users\\Karen\\eclipse-workspace\\Snakyy (1).zip_expanded\\Snake_Game\\music.png").getImage();
